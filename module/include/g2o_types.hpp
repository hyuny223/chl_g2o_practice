...
namespace myslam
{
    ...
    public:
        ...
        EdgeProjectionPoseOnly(const Eigen::Matrix<double, 3, 1> &pos, const Eigen::Matrix<double, 3, 3> &K)
            : _pos3d(pos), _K(K) {}
        ...
        virtual void computeError() override
        {
            ...
            Eigen::Matrix<double, 3, 1> pos_pixel = _K * (T * _pos3d);
        ...
        virtual void linearizeOplus() override
        {
            const VertexPose *v = static_cast<VertexPose *>(_vertices[0]);
            Sophus::SE3d T = v->estimate();
            Eigen::Matrix<double, 3, 1> pos_cam = T * _pos3d;
            double fx = _K(0, 0);
            double fy = _K(1, 1);
            double X = pos_cam[0];
            double Y = pos_cam[1];
    ...
    private:
        Eigen::Matrix<double, 3, 1> _pos3d;
